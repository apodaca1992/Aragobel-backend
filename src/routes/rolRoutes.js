...
const { rolSchema, updateRolSchema } = require('../validations/rol.validation');
...
router.put('/:id', validarToken, checkPermission(), validate(updateRolSchema), rolController.updateRol);      // Actualizar
