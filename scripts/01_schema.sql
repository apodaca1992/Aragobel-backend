...
-- Agregando Borrado Lógico (deletedAt) a todas las tablas
ALTER TABLE tiendas ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE puestos ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE tipo_registros_checador ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE permisos ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE aplicaciones ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE roles ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE empleados ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE usuarios ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE vehiculos ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE entregas ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE registros_checador ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE roles_aplicaciones ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE recursos ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE roles_recursos_permisos ADD COLUMN deletedAt DATETIME DEFAULT NULL;
ALTER TABLE usuarios_roles ADD COLUMN deletedAt DATETIME DEFAULT NULL;

CREATE TABLE IF NOT EXISTS dispositivos_android (
    id_dispositivo INT NOT NULL AUTO_INCREMENT,
    id_usuario INT NOT NULL, -- Relación con tu tabla de usuarios
    ...
    deletedAt DATETIME DEFAULT NULL, -- Siguiendo tu lógica de Borrado Lógico
